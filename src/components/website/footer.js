    ...
    <>
      <footer className="footer-main">
        <div className="footer-inner">
          ...
          <div className="footer-nav-grid">
            <div className="footer-nav-col">
              <h6 className="footer-col-heading footer-col-heading--green">
                Explore
              </h6>
              <ul>
                <li>
            ...
            <div className="footer-nav-col">
              <h6 className="footer-col-heading footer-col-heading--yellow">
                Anthology
              </h6>
              <ul>
                <li>
                  <Link to="/anthology-kaduna">Kaduna</Link>
                </li>{" "}
                <li>
                  <Link to="/anthology-lagos">Lagos</Link>
                </li>
              </ul>

              <h6 className="footer-col-heading footer-col-heading--blue mt-col">
                Store
              </h6>
              <ul>
                <li>
            ...
            <div className="footer-nav-col">
              <h6 className="footer-col-heading footer-col-heading--orange">
                Contact
              </h6>
              <ul>
                <li>
                ...
                <li>
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <i className="bi bi-geo-alt me-2"></i>32, Ikosi Road, Ketu,
                    Lagos
                  </a>
                </li>
              </ul>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            &copy; {new Date().getFullYear()} Jolevi. All rights reserved.
          </p>
