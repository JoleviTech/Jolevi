    ...
    <div className="">
      <div className="container-fluid PrivacyAndPolicyHero pt-5 px-lg-5 px-md-5">
        <div className="row my-lg-3 mx-lg-3">
          <div className="d-none d-lg-block d-md-block d-sm-none">
            <h3 className="container">Jolevi Privacy Policy</h3>
          </div>
          <div className="container-fluid d-lg-none d-md-none d-sm-block d-xs-block">
            <h3 className="text-center">Jolevi Privacy Policy</h3>
          </div>
        </div>
      </div>
      <div className="container mt-4">
        ...
        <p>
          ...
          stored by our payment processor, [Paystack] and you are encouraged to
        ...
        <p>
          ...
          your name, your social network username, location, gender, birth date,
          email address, profile picture, and public data for contacts, if you
          connect your account to such social networks. [If you are using our
          mobile application, this information may also include the contact
          information of anyone you invite to use and/or join our mobile
          application
        </p>
        ...
        <ul>
          <li>
            <strong style={{ fontStyle: "italic" }} className="pe-3">
          ...
          <li>
            ...
            social media accounts, storage,] and other features. If you wish to
          ...
          <li>
            ...
            We may collect device information (such as your mobile device ID,
            model and manufacturer), operating system, version information and
            IP address.
          </li>
          <li>
            <strong style={{ fontStyle: "italic" }} className="pe-3">
        ...
        <h3 className="mt-5 mb-3">USE OF YOUR INFORMATION</h3>
        <p>
          Having accurate information about you permits us to provide you with a
          smooth, efficient, and customized experience. Specifically, we may use
          information collected about you via the Site [or our mobile
          application] to:
        </p>
        <ul>
        ...
        <p>
          ...
          our mobile applications], your posts may be viewed by all users and
          may be publicly distributed outside the Site [and our mobile
        ...
        <p>
          ...
          that the transferee may decline honour commitments we made in this
          Privacy Policy.
        </p>
        <p>
        ...
        <h3 className="mt-5 mb-3">TRACKING TECHNOLOGIES</h3>
        ...
        <p>
          ...
          experience. When you access the Site [or our mobile application], your
          ...
          affect the availability and functionality of the Site [or our mobile
        ...
        <h3 className="mt-5 mb-3">Website Analytics</h3>
        <p>
          We may also partner with selected third-party vendors[, such as [Adobe
          Analytics,] [Cloudflare,] [Google Analytics,] tracking technologies
          and remarketing services on the Site [and our mobile application]
          through the use of first-party cookies and third-party cookies, to,
          among other things, analyze and track users’ use of the Site [and our
          mobile application], determine the popularity of certain content and
          better understand online activity. By accessing the Site, [our mobile
        ...
        <h3 className="mt-5 mb-3"> THIRD-PARTY WEBSITES</h3>
        <p>
        ...
        <h3 className="mt-5 mb-3">POLICY FOR CHILDREN</h3>
        <p>
        ...
        <h3 className="mt-5 mb-3"> CONTROLS FOR DO-NOT-TRACK FEATURES </h3>
        <p>
          ...
          that practice in a revised version of this Privacy Policy./Most web
          browsers and some mobile operating systems [and our mobile
          applications] include a Do-Not-Track (“DNT”) feature or setting you
          can activate to signal your privacy preference not to have data about
          your online browsing activities monitored and collected. If you set
          the DNT signal on your browser, we will respond to such DNT browser
          signals.
        </p>
        <h3 className="mt-5 mb-3">OPTIONS REGARDING YOUR INFORMATION</h3>
        <p>
          [Account Information]
          <br />
          <br />
        ...
        <h4> NIGERIAN PRIVACY RIGHTS </h4>
        <p>
          Nigeria's principal data protection legislation is the Nigeria Data
          Protection Regulation 2019 (“NDPR”). The NDPR was issued by the
          National Information Technology Development Agency (“NITDA/the
          Agency”) on 25 January 2019 pursuant to Section 32 of the NITDA Act
          2007 as subsidiary legislation to the NITDA Act 2007
          <br />
          <br />
          The NDPR mandates all organizations that process the personal data of
          more than 1000 data subjects in a period of 6 months and 2000 Data
          Subjects in a period of 12 months to submit a Data Protection Audit
          report to NITDA not later than 15th March every year.
          <br />
          {/* <br />
        ...
        <p>
          ...
          <a
            ...
            className="text-decoration-none linkColor ms-2"
          >
          ...
          {/* <div className="mb-sm-0 mx-3"></div>
          Jolevi */}
        </p>
      </div>
    </div>
