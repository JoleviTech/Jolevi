...
She writes at the intersection of personal experience and universal truth — turning the ordinary into the profound. When she's not writing, she mentors emerging voices and advocates for African literature on the global stage.`,
    ...
    gallery: [
      { src: authorImg, alt: "Titi Ekundayo at a reading event" },
      { src: authorImg, alt: "Titi signing copies of Threads of a Mind" },
      { src: authorImg, alt: "Titi at the Lagos Book Festival" },
    ],
    accentColor: "#5eb251",
    // Contact details — add/remove fields freely
    contact: {
      email: "titi@jolevi.com",
      instagram: "https://www.instagram.com/jolevibooks",
